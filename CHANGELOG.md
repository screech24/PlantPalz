...
- Plant selection in the 3D scene with visual highlighting
- Tabbed interface for plant controls to save space
- Ability to interact with individual plants directly in the garden view
- Visual highlighting for the selected plant in the 3D scene

### Changed
- Enhanced useGardenScene hook to support plant selection
